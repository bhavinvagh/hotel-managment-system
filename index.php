...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">fortunehotel@gmail.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 7990997136</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">FORTUNE <span>HOTEL</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">FORTUNE HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our FORTUNE HOTEL</h3> 
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/98.jpg" height="300" width="300" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/101.jpg" height="300" width="300" alt=" " class="img-responsive" />
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Very good place to stay worth to come again , very good food, room 
									. </p>
								<h5>Ahi Niranjani</h5>
								<p></p>
							</div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>staff behaviour is very nice,  provide good  facility also</p>
								<h5>Yash Chavda</h5>
								<p></p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p> very good view from balcony. </p>
								<h5>Harsh Panchotiya</h5>
								<p></p>
							</div>
							<div class="clearfix"> </div>
						</li>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/abc.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
								...
								<p> very delecious food . </p>
								<h5>Amit Vadodariya</h5>
								<p></p>
							</div>
							<div class="clearfix"> </div>
						</li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 7990997136</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="#">fortunehotel@gmail.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Fortune Park JPS Grand, Rajkot Hotels in Rajkot . 150 Feet Ring Road, Near Mavdi Circle, Rajkot - 360004, Gujarat</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2022 FORTUNE HOTEL. All Rights Reserved | Bipin Chavda  & Bhavin Vagh  </p>
		    </div>
<!--/footer -->
<!-- js -->
